...
import {
  ...
  useCollator,
  useFilter
} from "./chunk-2VKFYKZ5.js";
import {
  require_pluralize
} from "./chunk-XNACAI67.js";
import {
  require_groupBy
} from "./chunk-JQWE3ZNC.js";
import {
  formatISO
} from "./chunk-WNCCTVR2.js";
import {
  ConfirmDialog,
  Layouts,
  create3 as create,
...
var ForwardRef$J2 = ForwardRef$I;
...
var DataManagerContext = (0, import_react2.createContext)();
var useDataManager = () => (0, import_react2.useContext)(DataManagerContext);
var FormModalNavigationContext = React.createContext();
var useFormModalNavigation = () => (0, import_react2.useContext)(FormModalNavigationContext);
...
var ContentTypeBuilderNav = () => {
  ...
  return (0, import_jsx_runtime2.jsxs)(SubNav, {
    "aria-label": pluginName,
    children: [
      (0, import_jsx_runtime2.jsx)(SubNavHeader, {
        searchable: true,
        value: search.value,
      ...
      (0, import_jsx_runtime2.jsx)(SubNavSections, {
        children: menu.map((section) => (0, import_jsx_runtime2.jsxs)(import_react2.Fragment, {
          children: [
            (0, import_jsx_runtime2.jsx)(SubNavSection, {
              label: formatMessage({
                id: section.title.id,
              ...
              children: section.links.map((link) => {
                if (link.links) {
                  return (0, import_jsx_runtime2.jsx)(SubNavLinkSection, {
                    label: (0, import_upperFirst.default)(link.title),
                    children: link.links.map((subLink) => (0, import_jsx_runtime2.jsx)(SubNavLink, {
                      tag: NavLink,
                      to: subLink.to,
                ...
                return (0, import_jsx_runtime2.jsx)(SubNavLinkCustom, {
                  tag: NavLink,
                  to: link.to,
                  active: link.active,
                  width: "100%",
            ...
            section.customLink && (0, import_jsx_runtime2.jsx)(Box, {
              paddingLeft: 7,
              children: (0, import_jsx_runtime2.jsx)(TextButton, {
...
`;
var newAttributes = [];
var NewBadge = () => (0, import_jsx_runtime2.jsx)(Flex, {
  grow: 1,
  ...
  children: (0, import_jsx_runtime2.jsxs)(Flex, {
    ...
    children: [
      (0, import_jsx_runtime2.jsx)(ForwardRef$J, {
        width: `1rem`,
        height: `1rem`,
        fill: "alternative600"
      }),
...
var AttributeOption = ({ type = "text" }) => {
  ...
  return (0, import_jsx_runtime2.jsx)(OptionBoxWrapper, {
    padding: 4,
    tag: "button",
    hasRadius: true,
    type: "button",
    ...
    children: (0, import_jsx_runtime2.jsxs)(Flex, {
      children: [
        (0, import_jsx_runtime2.jsx)(AttributeIcon, {
          type
        }),
          ...
          children: [
            (0, import_jsx_runtime2.jsxs)(Flex, {
              ...
              children: [
                ...
                newAttributes.includes(type) && (0, import_jsx_runtime2.jsx)(NewBadge, {})
              ]
            }),
...
var AttributeList = ({ attributes }) => (0, import_jsx_runtime2.jsx)(KeyboardNavigable, {
  tagName: "button",
    ...
    children: attributes.map((attributeRow, index2) => {
      return (
        ...
        (0, import_jsx_runtime2.jsx)(Grid.Root, {
          gap: 3,
          children: attributeRow.map((attribute) => (0, import_jsx_runtime2.jsx)(Grid.Item, {
            col: 6,
            direction: "column",
            alignItems: "stretch",
            children: (0, import_jsx_runtime2.jsx)(AttributeOption, {
              type: attribute
            })
          }, attribute))
        }, index2)
...
var EmptyCardGrid = () => {
  return (0, import_jsx_runtime2.jsx)(Flex, {
    ...
    children: [
      ...
      return (0, import_jsx_runtime2.jsx)(EmptyCard, {
        height: "138px",
        width: "375px",
        hasRadius: true
      }, `empty-card-${idx}`);
...
var EmptyAttributes = () => {
  ...
  return (0, import_jsx_runtime2.jsxs)(Box, {
    position: "relative",
    children: [
      (0, import_jsx_runtime2.jsx)(EmptyCardGrid, {}),
      (0, import_jsx_runtime2.jsx)(Box, {
        ...
        children: (0, import_jsx_runtime2.jsxs)(Flex, {
          ...
          direction: "column",
          children: [
            (0, import_jsx_runtime2.jsx)(ForwardRef$J2, {
              width: "160px",
              height: "88px"
            }),
            (0, import_jsx_runtime2.jsx)(Box, {
...
var CustomFieldsList = () => {
  ...
  if (!registeredCustomFields.length) {
    return (0, import_jsx_runtime2.jsx)(EmptyAttributes, {});
  }
  const sortedCustomFields = registeredCustomFields.sort((a, b) => a[1].name > b[1].name ? 1 : -1);
  return (0, import_jsx_runtime2.jsx)(KeyboardNavigable, {
    tagName: "button",
    children: (0, import_jsx_runtime2.jsxs)(Flex, {
      direction: "column",
      alignItems: "stretch",
      ...
      children: [
        (0, import_jsx_runtime2.jsx)(Grid.Root, {
          gap: 3,
          children: sortedCustomFields.map(([uid, customField]) => (0, import_jsx_runtime2.jsx)(Grid.Item, {
            col: 6,
            direction: "column",
            alignItems: "stretch",
            children: (0, import_jsx_runtime2.jsx)(CustomFieldOption, {
              customFieldUid: uid,
              customField
            }, uid)
          }, uid))
        }),
        (0, import_jsx_runtime2.jsx)(Link2, {
...
var AttributeOptions = ({ attributes, forTarget, kind }) => {
  ...
  return (0, import_jsx_runtime2.jsx)(Modal.Body, {
    children: (0, import_jsx_runtime2.jsxs)(Tabs.Root, {
      ...
      children: [
        ...
        (0, import_jsx_runtime2.jsx)(Tabs.Content, {
          value: "default",
          children: (0, import_jsx_runtime2.jsx)(AttributeList, {
            attributes
          })
        }),
        (0, import_jsx_runtime2.jsx)(Tabs.Content, {
          value: "custom",
          children: (0, import_jsx_runtime2.jsx)(CustomFieldsList, {})
        })
      ]
    })
  });
...
var CustomRadioGroup = ({ intlLabel, name, onChange, radios = [], value }) => {
  ...
  return (0, import_jsx_runtime2.jsxs)(Flex, {
    ...
    children: [
      ...
      (0, import_jsx_runtime2.jsx)(Wrapper$1, {
        gap: 4,
        alignItems: "stretch",
        children: radios.map((radio) => {
          return (0, import_jsx_runtime2.jsxs)("label", {
...
var BooleanRadioGroup = ({ onChange, name, intlLabel, ...rest }) => {
  ...
  return (0, import_jsx_runtime2.jsx)(CustomRadioGroup, {
    ...rest,
    name,
    onChange: handleChange,
    intlLabel
...
var CheckboxWithNumberField = ({ error, intlLabel, modifiedData, name, onChange, value = null }) => {
  ...
  return (0, import_jsx_runtime2.jsxs)(Flex, {
    ...
    children: [
      ...
      value !== null && (0, import_jsx_runtime2.jsx)(Box, {
        paddingLeft: 6,
        style: {
          maxWidth: "200px"
        },
        children: type === "text" ? (0, import_jsx_runtime2.jsxs)(Field.Root, {
          error: errorMessage,
          name,
          children: [
          ...
          name,
          children: [
            (0, import_jsx_runtime2.jsx)(NumberInput, {
              "aria-label": label,
              disabled,
...
var DraftAndPublishToggle = ({ description, disabled = false, intlLabel, isCreating, name, onChange, value = false }) => {
  const { formatMessage } = useIntl();
  const [showWarning, setShowWarning] = (0, import_react2.useState)(false);
  const label = intlLabel.id ? formatMessage({
    id: intlLabel.id,
    defaultMessage: intlLabel.defaultMessage
  }, {
    ...
    children: [
      ...
      (0, import_jsx_runtime2.jsx)(Dialog.Root, {
        ...
        children: (0, import_jsx_runtime2.jsx)(ConfirmDialog, {
          endAction: (0, import_jsx_runtime2.jsx)(Button, {
...
var FormModalEndActions = ({ categoryName, deleteCategory, deleteComponent, deleteContentType, isAttributeModal, isCustomFieldModal, isComponentAttribute, isComponentToDzModal, isContentTypeModal, isCreatingComponent, isCreatingComponentAttribute, isCreatingComponentInDz, isCreatingComponentWhileAddingAField, isCreatingContentType, isCreatingDz, isComponentModal, isDzAttribute, isEditingAttribute, isEditingCategory, isInFirstComponentStep, onSubmitAddComponentAttribute, onSubmitAddComponentToDz, onSubmitCreateContentType, onSubmitCreateComponent, onSubmitCreateDz, onSubmitEditAttribute, onSubmitEditCategory, onSubmitEditComponent, onSubmitEditContentType, onSubmitEditCustomFieldAttribute, onSubmitEditDz, onClickFinish }) => {
  ...
  if (isContentTypeModal) {
    return (0, import_jsx_runtime2.jsxs)(Flex, {
      gap: 2,
      children: [
        !isCreatingContentType && (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, {
          children: [
            (0, import_jsx_runtime2.jsx)(Button, {
              type: "button",
              variant: "danger",
        ...
        isCreatingContentType && (0, import_jsx_runtime2.jsx)(Button, {
          type: "submit",
          variant: "secondary",
          onClick: (e) => {
            e.preventDefault();
  ...
  if (isComponentModal) {
    return (0, import_jsx_runtime2.jsxs)(Flex, {
      gap: 2,
      children: [
        !isCreatingComponent && (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, {
          children: [
            (0, import_jsx_runtime2.jsx)(Button, {
              type: "button",
              variant: "danger",
        ...
        isCreatingComponent && (0, import_jsx_runtime2.jsx)(Button, {
          type: "submit",
          variant: "secondary",
          onClick: (e) => {
            e.preventDefault();
...
var FormModalHeader = ({ actionType = null, attributeName, attributeType, categoryName, contentTypeKind, dynamicZoneTarget, forTarget, modalType = null, targetUid, customFieldUid = null, showBackLink = false }) => {
  ...
  if (isCreatingMainSchema) {
    ...
    return (0, import_jsx_runtime2.jsx)(Modal.Header, {
      children: (0, import_jsx_runtime2.jsxs)(Flex, {
        children: [
          (0, import_jsx_runtime2.jsx)(Box, {
            children: (0, import_jsx_runtime2.jsx)(AttributeIcon, {
              type: icon
            })
          }),
          (0, import_jsx_runtime2.jsx)(Box, {
  ...
  return (0, import_jsx_runtime2.jsx)(Modal.Header, {
    children: (0, import_jsx_runtime2.jsxs)(Flex, {
      ...
      children: [
        ...
        (0, import_jsx_runtime2.jsx)(Breadcrumbs, {
          ...
          children: headers.map(({ label, info }, index2, arr) => {
            ...
            return (0, import_jsx_runtime2.jsx)(Crumb, {
...
var IconPick = ({ iconKey, name, onChange, isSelected, ariaLabel }) => {
  ...
  return (0, import_jsx_runtime2.jsx)(Field.Root, {
    name,
    required: false,
    children: (0, import_jsx_runtime2.jsxs)(Field.Label, {
      children: [
        (0, import_jsx_runtime2.jsxs)(VisuallyHidden, {
          children: [
            ariaLabel,
            (0, import_jsx_runtime2.jsx)(Field.Input, {
              type: "radio",
              checked: isSelected,
              onChange,
              value: iconKey,
...
var IconPicker = ({ intlLabel, name, onChange, value = "" }) => {
  ...
  const [icons, setIcons] = (0, import_react2.useState)(allIcons);
  const searchIconRef = (0, import_react2.useRef)(null);
  const searchBarRef = (0, import_react2.useRef)(null);
  const toggleSearch = () => {
  ...
  return (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, {
    children: [
      (0, import_jsx_runtime2.jsxs)(Flex, {
        ...
        children: [
          ...
          (0, import_jsx_runtime2.jsxs)(Flex, {
            gap: 1,
            children: [
              showSearch ? (0, import_jsx_runtime2.jsx)(Searchbar, {
                ref: searchBarRef,
                name: "searchbar",
                ...
                variant: "ghost",
                children: (0, import_jsx_runtime2.jsx)(ForwardRef$X, {})
              }),
              value && (0, import_jsx_runtime2.jsx)(TooltipImpl, {
                label: formatMessage({
      ...
      (0, import_jsx_runtime2.jsx)(IconPickerWrapper, {
        position: "relative",
        padding: 1,
        ...
        overflow: "auto",
        textAlign: "center",
        children: icons.length > 0 ? icons.map((iconKey) => (0, import_jsx_runtime2.jsx)(IconPick, {
          iconKey,
          name,
          onChange,
        ...
        }, iconKey)) : (0, import_jsx_runtime2.jsx)(Box, {
          padding: 4,
          grow: 2,
          children: (0, import_jsx_runtime2.jsx)(Typography, {
            variant: "delta",
...
var GenericInput = ({ autoComplete, customInputs, description, disabled, intlLabel, labelAction, error, name, onChange, options: options2 = [], placeholder, required, step, type, value: defaultValue, isNullable, attribute, ...rest }) => {
  ...
  if (CustomInput) {
    return (0, import_jsx_runtime2.jsx)(CustomInput, {
      ...rest,
      attribute,
      description,
      hint,
  ...
  const getComponent = () => {
    switch (type) {
      case "json": {
        return (0, import_jsx_runtime2.jsx)(JSONInput, {
          value,
          disabled,
          onChange: (json) => {
      ...
      case "bool": {
        return (0, import_jsx_runtime2.jsx)(Toggle, {
      ...
      case "checkbox": {
        return (0, import_jsx_runtime2.jsx)(CheckboxImpl, {
          disabled,
          onCheckedChange: (value2) => {
            onChange({
              target: {
      ...
      case "datetime": {
        ...
        return (0, import_jsx_runtime2.jsx)(DateTimePicker, {
          clearLabel: formatMessage({
            id: "clearLabel",
      ...
      case "date": {
        const dateValue = parseDateValue(value);
        return (0, import_jsx_runtime2.jsx)(DatePicker$1, {
          clearLabel: formatMessage({
            id: "clearLabel",
            defaultMessage: "Clear"
          }),
      ...
      case "number": {
        return (0, import_jsx_runtime2.jsx)(NumberInput, {
          disabled,
          onValueChange: (value2) => {
            onChange({
              target: {
      ...
      case "email": {
        return (0, import_jsx_runtime2.jsx)(TextInput, {
          autoComplete,
          disabled,
          onChange: (e) => {
            onChange({
      ...
      case "password": {
        return (0, import_jsx_runtime2.jsx)(TextInput, {
          ...
          endAction: (0, import_jsx_runtime2.jsx)("button", {
            ...
            type: "button",
            children: showPassword ? (0, import_jsx_runtime2.jsx)(ForwardRef$3D, {
              fill: "neutral500"
            }) : (0, import_jsx_runtime2.jsx)(ForwardRef$3B, {
              fill: "neutral500"
            })
          }),
          onChange: (e) => {
      ...
      case "textarea": {
        return (0, import_jsx_runtime2.jsx)(Textarea, {
          disabled,
      ...
      case "time": {
        ...
        return (0, import_jsx_runtime2.jsx)(TimePicker$1, {
          clearLabel: formatMessage({
            id: "clearLabel",
            defaultMessage: "Clear"
          }),
  ...
  return (0, import_jsx_runtime2.jsxs)(Field.Root, {
    ...
    required,
    children: [
      type !== "checkbox" ? (0, import_jsx_runtime2.jsx)(Field.Label, {
        action: labelAction,
        children: label
      }) : null,
      getComponent(),
...
var useFieldHint = ({ description, fieldSchema, type }) => {
  ...
  const buildHint = () => {
    ...
    return formatMessage({
      ...
      br: hasMinOrMax ? (0, import_jsx_runtime2.jsx)("br", {}) : null
    });
  };
  return {
    hint: buildHint()
...
var RelationTargetPicker = ({ oneThatIsCreatingARelationWithAnother, target }) => {
  ...
  return (0, import_jsx_runtime2.jsxs)(Menu.Root, {
    children: [
      (0, import_jsx_runtime2.jsx)(MenuTrigger, {
        children: `${displayName} ${plugin ? `(from: ${plugin})` : ""}`
      }),
      (0, import_jsx_runtime2.jsx)(Menu.Content, {
        zIndex: "popover",
        children: allowedContentTypesForRelation.map(({ uid, title, restrictRelationsTo, plugin: plugin2 }) => (0, import_jsx_runtime2.jsxs)(Menu.Item, {
          ...
          children: [
            title,
            " ",
            plugin2 && (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, {
              children: [
                "(from: ",
                plugin2,
                ")"
  ...
  return (0, import_jsx_runtime2.jsxs)(Box, {
    ...
    children: [
      (0, import_jsx_runtime2.jsx)(Flex, {
        ...
        justifyContent: "center",
        children: isMain ? (0, import_jsx_runtime2.jsx)(Typography, {
          variant: "pi",
          fontWeight: "bold",
          textColor: "neutral800",
          children: header
        }) : (0, import_jsx_runtime2.jsx)(RelationTargetPicker, {
          target,
          oneThatIsCreatingARelationWithAnother
        })
      }),
      ...
      (0, import_jsx_runtime2.jsx)(Box, {
        padding: 4,
        children: (0, import_jsx_runtime2.jsx)(MemoizedGenericInput, {
          disabled,
...
var RelationNaturePicker = ({ naturePickerType, oneThatIsCreatingARelationWithAnother, relationType, target }) => {
  ...
  return (0, import_jsx_runtime2.jsxs)(Flex, {
    ...
    children: [
      (0, import_jsx_runtime2.jsx)(Wrapper, {
        children: (0, import_jsx_runtime2.jsx)(Flex, {
          paddingLeft: 9,
          paddingRight: 9,
          paddingTop: 1,
          justifyContent: "center",
          children: (0, import_jsx_runtime2.jsx)(KeyboardNavigable, {
            tagName: "button",
            children: (0, import_jsx_runtime2.jsx)(Flex, {
              gap: 3,
              children: relationsType.map((relation) => {
                ...
                return (0, import_jsx_runtime2.jsx)(IconWrapper, {
                  tag: "button",
                  ...
                  children: (0, import_jsx_runtime2.jsx)(Asset, {
                    "aria-hidden": "true"
                  }, relation)
                }, relation);
              })
      ...
      (0, import_jsx_runtime2.jsxs)(InfosWrapper, {
        justifyContent: "center",
        children: [
...
var Relation = ({ formErrors, mainBoxHeader, modifiedData, naturePickerType, onChange }) => {
  ...
  return (0, import_jsx_runtime2.jsxs)(Flex, {
    ...
    children: [
      (0, import_jsx_runtime2.jsx)(RelationFormBox, {
        isMain: true,
      ...
      (0, import_jsx_runtime2.jsx)(RelationNaturePicker, {
        naturePickerType,
...
var SelectCategory = ({ error = null, intlLabel, name, onChange, value = void 0, isCreating, dynamicZoneTarget }) => {
  ...
  const [categories, setCategories] = (0, import_react2.useState)(allComponentsCategories);
  const errorMessage = error ? formatMessage({
    id: error,
    defaultMessage: error
  }) : "";
  ...
  return (0, import_jsx_runtime2.jsxs)(Field.Root, {
    ...
    children: [
      ...
      (0, import_jsx_runtime2.jsx)(Combobox, {
        ...
        value,
        creatable: true,
        children: categories.map((category) => (0, import_jsx_runtime2.jsx)(Option, {
          value: category,
          children: category
        }, category))
      }),
...
var TabForm = ({ form, formErrors, genericInputProps, modifiedData, onChange }) => {
  ...
  return (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, {
    children: form.map((section, sectionIndex) => {
      ...
      return (0, import_jsx_runtime2.jsxs)(Box, {
        children: [
          section.sectionTitle && (0, import_jsx_runtime2.jsx)(Box, {
            paddingBottom: 4,
            children: (0, import_jsx_runtime2.jsx)(Typography, {
              variant: "delta",
              tag: "h3",
...
var FormModal = () => {
  ...
  return (0, import_jsx_runtime2.jsx)(Modal.Root, {
    ...
    children: (0, import_jsx_runtime2.jsxs)(Modal.Content, {
      children: [
        (0, import_jsx_runtime2.jsx)(FormModalHeader, {
          actionType,
          attributeName,
          categoryName,
        ...
        isPickingAttribute && (0, import_jsx_runtime2.jsx)(AttributeOptions, {
          attributes: displayedAttributes,
          forTarget,
          kind: schemaKind || "collectionType"
        }),
        !isPickingAttribute && (0, import_jsx_runtime2.jsxs)(FormComponent, {
          ...
          children: [
              ...
              children: (0, import_jsx_runtime2.jsxs)(Tabs.Root, {
                ...
                children: [
                  (0, import_jsx_runtime2.jsxs)(Flex, {
                    justifyContent: "space-between",
                    children: [
                      (0, import_jsx_runtime2.jsx)(FormModalSubHeader, {
                        actionType,
                        forTarget,
                        kind,
                        step,
                  ...
                  (0, import_jsx_runtime2.jsx)(Tabs.Content, {
                    ...
                    children: (0, import_jsx_runtime2.jsx)(Flex, {
                      ...
                      alignItems: "stretch",
                      gap: 6,
                      children: (0, import_jsx_runtime2.jsx)(TabForm, {
                        form: baseForm2,
                        formErrors,
                        genericInputProps,
                        modifiedData,
            ...
            (0, import_jsx_runtime2.jsxs)(Modal.Footer, {
              children: [
                ...
                (0, import_jsx_runtime2.jsx)(FormModalEndActions, {
                  deleteCategory,
...
var DataManagerProvider = ({ children }) => {
  ...
  const getDataRef = (0, import_react2.useRef)();
  ...
  const shouldRedirect = (0, import_react2.useMemo)(() => {
  ...
  const redirectEndpoint = (0, import_react2.useMemo)(() => {
  ...
  return (0, import_jsx_runtime2.jsxs)(DataManagerContext.Provider, {
    value: {
      addAttribute,
    ...
    children: [
      children,
      isInDevelopmentMode && (0, import_jsx_runtime2.jsx)(FormModal, {})
    ]
  });
};
var DataManagerProvider$1 = (0, import_react2.memo)(DataManagerProvider);
...
var FormModalNavigationProvider = ({ children }) => {
  ...
  return (0, import_jsx_runtime2.jsx)(FormModalNavigationContext.Provider, {
    value: {
      ...state,
      onClickSelectField,
      onClickSelectCustomField,
...
var ListView = (0, import_react2.lazy)(() => import("./ListView-Cl-pbcxP-7UBROFE6.js"));
var App = () => {
  const { formatMessage } = useIntl();
  ...
  const startSectionRef = (0, import_react2.useRef)(startSection);
  (0, import_react2.useEffect)(() => {
    if (startSectionRef.current) {
      startSectionRef.current("contentTypeBuilder");
    }
  }, []);
  return (0, import_jsx_runtime2.jsxs)(Page.Protect, {
    permissions: PERMISSIONS.main,
    children: [
      (0, import_jsx_runtime2.jsx)(Page.Title, {
        children: title
      }),
      (0, import_jsx_runtime2.jsx)(AutoReloadOverlayBlockerProvider, {
        children: (0, import_jsx_runtime2.jsx)(FormModalNavigationProvider, {
          children: (0, import_jsx_runtime2.jsx)(DataManagerProvider$1, {
            children: (0, import_jsx_runtime2.jsx)(Layouts.Root, {
              sideNav: (0, import_jsx_runtime2.jsx)(ContentTypeBuilderNav, {}),
              children: (0, import_jsx_runtime2.jsx)(import_react2.Suspense, {
                fallback: (0, import_jsx_runtime2.jsx)(Page.Loading, {}),
                children: (0, import_jsx_runtime2.jsxs)(Routes, {
                  children: [
                    (0, import_jsx_runtime2.jsx)(Route, {
                      path: "content-types/:uid",
                      element: (0, import_jsx_runtime2.jsx)(ListView, {})
                    }),
                    (0, import_jsx_runtime2.jsx)(Route, {
...
lodash/lodash.min.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-U4R24MZP.js.map
