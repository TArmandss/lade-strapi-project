...
// node_modules/@strapi/i18n/node_modules/@radix-ui/number/dist/index.mjs
function $ae6933e535247d3d$export$7d15b64cf5a3a4c4(value, [min, max]) {
  return Math.min(max, Math.max(min, value));
}

// node_modules/@strapi/i18n/node_modules/@radix-ui/react-use-previous/dist/index.mjs
...
// node_modules/@strapi/i18n/node_modules/@radix-ui/react-visually-hidden/dist/index.mjs
  ...
  return (0, import_jsx_runtime4.jsxs)(Dialog.Root, {
    ...
    children: [
      (0, import_jsx_runtime4.jsxs)(Field.Root, {
        ...
        name,
        children: [
          (0, import_jsx_runtime4.jsx)(CheckboxImpl, {
      ...
      (0, import_jsx_runtime4.jsxs)(Dialog.Content, {
        children: [
          ...
          (0, import_jsx_runtime4.jsx)(Dialog.Body, {
            icon: (0, import_jsx_runtime4.jsx)(ForwardRef$3, {}),
            children: (0, import_jsx_runtime4.jsxs)(Flex, {
              ...
              children: [
                (0, import_jsx_runtime4.jsx)(Flex, {
                  justifyContent: "center",
                  children: (0, import_jsx_runtime4.jsx)(TextAlignTypography, {
                    children: formatMessage({
          ...
          (0, import_jsx_runtime4.jsxs)(Dialog.Footer, {
            children: [
              ...
              (0, import_jsx_runtime4.jsx)(Dialog.Action, {
                children: (0, import_jsx_runtime4.jsx)(Button, {
...
var BulkLocaleActionModal = ({ headers, rows, localesMetadata, validationErrors = {}, action }) => {
  ...
  return (0, import_jsx_runtime4.jsxs)(Modal.Body, {
    children: [
      (0, import_jsx_runtime4.jsx)(Typography, {
      ...
      (0, import_jsx_runtime4.jsx)(Box, {
        marginTop: 5,
        children: (0, import_jsx_runtime4.jsxs)(Table.Content, {
          children: [
            (0, import_jsx_runtime4.jsxs)(Table.Head, {
              children: [
                (0, import_jsx_runtime4.jsx)(Table.HeaderCheckboxCell, {}),
                headers.map((head) => (0, import_jsx_runtime4.jsx)(Table.HeaderCell, {
                  ...head
                }, head.name))
              ]
            }),
            (0, import_jsx_runtime4.jsx)(Table.Body, {
              children: rows.map(({ locale, status }, index2) => {
                ...
                return (0, import_jsx_runtime4.jsxs)(Table.Row, {
                  children: [
                    ...
                    (0, import_jsx_runtime4.jsx)(Table.Cell, {
                      children: (0, import_jsx_runtime4.jsx)(Box, {
                        display: "flex",
                        children: (0, import_jsx_runtime4.jsx)(Status, {
                          display: "flex",
                          paddingLeft: "6px",
                          paddingRight: "6px",
                          paddingTop: "2px",
                    ...
                    (0, import_jsx_runtime4.jsx)(Table.Cell, {
                      children: (0, import_jsx_runtime4.jsx)(EntryValidationText, {
...
var LocaleOption = ({ isDraftAndPublishEnabled, locale, status, entryExists }) => {
  ...
  if (!entryExists) {
    return formatMessage({
      ...
      bold: (locale2) => (0, import_jsx_runtime4.jsx)("b", {
        children: locale2
      }),
      locale: locale.name
    });
  ...
  return (0, import_jsx_runtime4.jsxs)(Flex, {
    ...
    children: [
      ...
      isDraftAndPublishEnabled ? (0, import_jsx_runtime4.jsx)(Status, {
        display: "flex",
        paddingLeft: "6px",
        paddingRight: "6px",
        paddingTop: "2px",
...
var LocalePickerAction = ({ document: document2, meta, model, collectionType, documentId }) => {
  ...
  const allCurrentLocales = [
    ...
    ...(document2 == null ? void 0 : document2.localizations) ?? []
  ];
  ...
  return {
    ...
    options: displayedLocales.map((locale) => {
      ...
      return {
        ...
        value: locale.code,
        label: (0, import_jsx_runtime4.jsx)(LocaleOption, {
        ...
        startIcon: !entryWithLocaleExists ? (0, import_jsx_runtime4.jsx)(ForwardRef$1h, {}) : null
      };
    }),
...
var FillFromAnotherLocaleAction = ({ documentId, meta, model, collectionType }) => {
  ...
  return {
    type: "icon",
    icon: (0, import_jsx_runtime4.jsx)(ForwardRef$3P, {}),
    ...
    dialog: {
      ...
      content: ({ onClose }) => (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, {
        children: [
          (0, import_jsx_runtime4.jsx)(Dialog.Body, {
            children: (0, import_jsx_runtime4.jsxs)(Flex, {
              direction: "column",
                ...
                (0, import_jsx_runtime4.jsxs)(Field.Root, {
                  ...
                  children: [
                    ...
                    (0, import_jsx_runtime4.jsx)(SingleSelect, {
                      ...
                      children: availableLocales.map((locale) => (0, import_jsx_runtime4.jsx)(SingleSelectOption, {
                        value: locale.code,
                        children: locale.name
                      }, locale.code))
                    })
          ...
          (0, import_jsx_runtime4.jsx)(Dialog.Footer, {
            children: (0, import_jsx_runtime4.jsxs)(Flex, {
              gap: 2,
              width: "100%",
              children: [
...
var DeleteLocaleAction = ({ document: document2, documentId, model, collectionType }) => {
  ...
  return {
    ...
    icon: (0, import_jsx_runtime4.jsx)(StyledTrash, {}),
    variant: "danger",
    dialog: {
      type: "dialog",
      title: formatMessage({
...
var BulkLocaleAction = ({ document: document2, documentId, model, collectionType, action }) => {
  var _a;
  ...
  const [rows, validationErrors] = React3.useMemo(() => {
    ...
    const localizations = document2.localizations ?? [];
  ...
  return {
    ...
    icon: isBulkPublish ? (0, import_jsx_runtime4.jsx)(ForwardRef$2n, {}) : (0, import_jsx_runtime4.jsx)(ForwardRef$45, {}),
    ...
    dialog: {
      ...
      content: () => {
        return (0, import_jsx_runtime4.jsx)(Table.Root, {
          ...
          children: (0, import_jsx_runtime4.jsx)(BulkLocaleActionModal, {
            validationErrors,
            headers,
            rows,
            localesMetadata,
      ...
      footer: () => (0, import_jsx_runtime4.jsx)(Modal.Footer, {
...
var LocalePicker = () => {
  ...
  const handleChange = React3.useCallback((code, replace = false) => {
    setQuery({
      page: 1,
      plugins: {
        ...query.plugins,
  ...
  return (0, import_jsx_runtime4.jsx)(SingleSelect, {
    ...
    onChange: handleChange,
    children: displayedLocales.map((locale) => (0, import_jsx_runtime4.jsx)(SingleSelectOption, {
      value: locale.code,
      children: locale.name
    }, locale.id))
  });
...
var addLabelActionToField = (field) => {
  ...
  const labelActionProps = {
    ...
    icon: isFieldLocalized ? (0, import_jsx_runtime4.jsx)(ForwardRef$3P, {}) : null
  };
  return {
    ...field,
    labelAction: isFieldLocalized ? (0, import_jsx_runtime4.jsx)(LabelAction2, {
      ...labelActionProps
    }) : null
  };
};
...
var LabelAction2 = ({ title, icon }) => {
  const { formatMessage } = useIntl();
  return (0, import_jsx_runtime4.jsxs)(Span2, {
    tag: "span",
    children: [
...
var LocaleListCell = ({ locale: currentLocale, localizations }) => {
  ...
  return (0, import_jsx_runtime4.jsxs)(Popover.Root, {
    children: [
      (0, import_jsx_runtime4.jsx)(Popover.Trigger, {
        children: (0, import_jsx_runtime4.jsx)(Button, {
          variant: "ghost",
          type: "button",
          ...
          children: (0, import_jsx_runtime4.jsxs)(Flex, {
            ...
            children: [
              ...
              (0, import_jsx_runtime4.jsx)(Flex, {
                children: (0, import_jsx_runtime4.jsx)(ForwardRef$4T, {
                  width: "1.2rem",
                  height: "1.2rem"
                })
              })
      ...
      (0, import_jsx_runtime4.jsx)(Popover.Content, {
        sideOffset: 16,
        children: (0, import_jsx_runtime4.jsx)("ul", {
          children: localesForDocument.map((name) => (0, import_jsx_runtime4.jsx)(Box, {
            padding: 3,
            tag: "li",
            children: (0, import_jsx_runtime4.jsx)(Typography, {
              children: name
  ...
  return {
    displayedHeaders: [
      ...displayedHeaders,
      {
        ...
        cellFormatter: (props, _header, meta) => (0, import_jsx_runtime4.jsx)(LocaleListCell, {
          ...props,
          ...meta
        })
      }
...
var index = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-BOEeBbiM-3DTNRJID.js").then((mod) => ({
...
//# sourceMappingURL=chunk-QH76GTE4.js.map
