...
var EditLocale = (props) => {
  ...
  return (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, {
    children: [
      ...
      (0, import_jsx_runtime2.jsx)(EditModal, {
        ...props,
        open: visible,
        onOpenChange: setVisible
      })
...
var EditModal = ({ id, code, isDefault, name, open, onOpenChange }) => {
  ...
  return (0, import_jsx_runtime2.jsx)(Modal.Root, {
    open,
    onOpenChange,
    children: (0, import_jsx_runtime2.jsx)(Modal.Content, {
      children: (0, import_jsx_runtime2.jsxs)(Form, {
        method: "PUT",
        onSubmit: handleSubmit,
        initialValues: {
  ...
  return (0, import_jsx_runtime2.jsxs)(Table, {
    ...
    children: [
      ...
      (0, import_jsx_runtime2.jsx)(Tbody, {
        children: locales.map((locale) => (0, import_jsx_runtime2.jsxs)(React.Fragment, {
          children: [
              ...
              children: [
                ...
                (0, import_jsx_runtime2.jsx)(Td, {
                  children: (0, import_jsx_runtime2.jsxs)(Flex, {
                    ...
                    children: [
                      canUpdate && (0, import_jsx_runtime2.jsx)(EditLocale, {
                        ...locale
                      }),
                      canDelete && !locale.isDefault && (0, import_jsx_runtime2.jsx)(DeleteLocale, {
                        ...locale
                      })
                    ]
                  })
  ...
  return (0, import_jsx_runtime2.jsxs)(Page.Main, {
    ...
    children: [
      (0, import_jsx_runtime2.jsx)(Layouts.Header, {
        primaryAction: (0, import_jsx_runtime2.jsx)(CreateLocale, {
          disabled: !canCreate
        }),
        title: formatMessage({
      ...
      (0, import_jsx_runtime2.jsx)(Layouts.Content, {
        children: locales.length > 0 ? (0, import_jsx_runtime2.jsx)(LocaleTable, {
          locales,
          canDelete,
          canUpdate
        }) : (0, import_jsx_runtime2.jsx)(EmptyStateLayout, {
          ...
          action: (0, import_jsx_runtime2.jsx)(CreateLocale, {
            disabled: !canCreate,
            variant: "secondary"
          })
        })
...
var ProtectedSettingsPage = () => {
  return (0, import_jsx_runtime2.jsx)(Page.Protect, {
    ...
    children: (0, import_jsx_runtime2.jsx)(SettingsPage, {})
  });
};
export {
...
//# sourceMappingURL=SettingsPage-BOEeBbiM-3DTNRJID.js.map
