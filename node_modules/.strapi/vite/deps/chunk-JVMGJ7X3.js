...
// node_modules/@strapi/content-manager/node_modules/@radix-ui/number/dist/index.mjs
function $ae6933e535247d3d$export$7d15b64cf5a3a4c4(value, [min, max]) {
  return Math.min(max, Math.max(min, value));
}

// node_modules/@strapi/content-manager/node_modules/@radix-ui/react-use-previous/dist/index.mjs
...
// node_modules/@strapi/content-manager/node_modules/@radix-ui/react-visually-hidden/dist/index.mjs
...
var createContext3 = (rootComponentName, defaultContext) => {
...
`;
var [AccordionProvider, useAccordion] = createContext3("Accordion");
...
var inputFocusStyle = (rootElement = "&") => ({ theme, $hasError = false }) => lt`
  ...
  `;
var [FieldProvider, useField] = createContext3("Field", {});
...
var [Provider, useDesignSystem] = createContext3("StrapiDesignSystem", {
...
var [DatePickerProvider, useDatePickerContext] = createContext3("DatePicker");
...
var useTable2 = () => React2.useContext(RawTableContext);
...
var RawTd = React2.forwardRef(
  ({ coords = { col: 0, row: 0 }, tag = "td", ...props }, forwardedRef) => {
    ...
    const { rowIndex, colIndex, setTableValues } = useTable2();
...
`;
var [TabsProvider, useTabs] = createContext3("Tabs");
...
var ScrollContainer = dt(Box)`
  overflow-x: auto;
`;
var Table2 = React2.forwardRef(({ footer, ...props }, forwardedRef) => {
  const tableRef = React2.useRef(null);
...
var InjectionZone = ({ area, ...props }) => {
  ...
  return (0, import_jsx_runtime4.jsx)(import_jsx_runtime4.Fragment, {
    children: components.map((component) => (0, import_jsx_runtime4.jsx)(component.Component, {
      ...props
    }, component.name))
  });
};
...
var DocumentRBAC = ({ children, permissions }) => {
  ...
  const contentTypePermissions = React3.useMemo(() => {
  ...
  const canUserAction = React3.useCallback((fieldName, fieldsUserCanAction, fieldType) => {
  ...
  return (0, import_jsx_runtime4.jsx)(DocumentRBACProvider, {
    isLoading,
    canCreateFields,
    canReadFields,
    canUpdateFields,
...
var useContentTypeSchema = (model) => {
  ...
  const { components, contentType, contentTypes } = React3.useMemo(() => {
  ...
  return {
    ...
    components: React3.useMemo(() => components ?? {}, [
      components
    ]),
    schema: contentType,
...
var useDocument = (args, opts) => {
  ...
  const validationSchema = React3.useMemo(() => {
    if (!schema) {
      return null;
    }
  ...
  const validate = React3.useCallback((document3) => {
    if (!validationSchema) {
  ...
  const getInitialFormValues = React3.useCallback((isCreatingDocument = false) => {
...
var useDocumentActions = () => {
  ...
  const create8 = React3.useCallback(async ({ model, params }, data, trackerProperty) => {
    try {
...
var ProtectedHistoryPage = React3.lazy(() => import("./History-DClLuGIg-24X5EAIW.js").then((mod) => ({
...
var ProtectedPreviewPage = React3.lazy(() => import("./Preview-05BZGpV2-AO64F7UW.js").then((mod) => ({
...
var ProtectedEditViewPage = (0, import_react5.lazy)(() => import("./EditViewPage-BAI2r49P-MZFEO77J.js").then((mod) => ({
  default: mod.ProtectedEditViewPage
})));
var ProtectedListViewPage = (0, import_react5.lazy)(() => import("./ListViewPage-Q0auz5lE-SUMFTH3K.js").then((mod) => ({
  default: mod.ProtectedListViewPage
})));
var ProtectedListConfiguration = (0, import_react5.lazy)(() => import("./ListConfigurationPage-Do3UDres-7QHBWZTV.js").then((mod) => ({
  default: mod.ProtectedListConfiguration
})));
var ProtectedEditConfigurationPage = (0, import_react5.lazy)(() => import("./EditConfigurationPage-KDwSFRyn-JVC2T65U.js").then((mod) => ({
  default: mod.ProtectedEditConfigurationPage
})));
var ProtectedComponentConfigurationPage = (0, import_react5.lazy)(() => import("./ComponentConfigurationPage-DKtL-tec-DUE5YIOX.js").then((mod) => ({
  default: mod.ProtectedComponentConfigurationPage
})));
var NoPermissions = (0, import_react5.lazy)(() => import("./NoPermissionsPage-BAW7WY-M-HDYXTNDG.js").then((mod) => ({
  default: mod.NoPermissions
})));
var NoContentType = (0, import_react5.lazy)(() => import("./NoContentTypePage-B_oOeOQb-EVFMBLPJ.js").then((mod) => ({
  ...
  return (0, import_jsx_runtime4.jsxs)(Flex, {
    ...
    children: [
      (0, import_jsx_runtime4.jsxs)(Flex, {
        gap: 2,
        children: [
          (0, import_jsx_runtime4.jsx)(DocumentActionButton, {
            ...primaryAction,
            variant: primaryAction.variant || "default"
          }),
          restActions.length > 0 ? (0, import_jsx_runtime4.jsx)(DocumentActionsMenu, {
            actions: restActions,
            label: formatMessage({
      ...
      secondaryAction ? (0, import_jsx_runtime4.jsx)(DocumentActionButton, {
        ...secondaryAction,
...
var DocumentActionButton = (action) => {
  var _a, _b, _c;
  const [dialogId, setDialogId] = React3.useState(null);
  const { toggleNotification } = useNotification();
  ...
  return (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, {
    children: [
      ...
      ((_a = action.dialog) == null ? void 0 : _a.type) === "dialog" ? (0, import_jsx_runtime4.jsx)(DocumentActionConfirmDialog, {
        ...action.dialog,
        variant: ((_b = action.dialog) == null ? void 0 : _b.variant) ?? action.variant,
        isOpen: dialogId === action.id,
        onClose: handleClose
      }) : null,
      ((_c = action.dialog) == null ? void 0 : _c.type) === "modal" ? (0, import_jsx_runtime4.jsx)(DocumentActionModal, {
        ...action.dialog,
...
var MenuItem2 = dt(Menu.Item)`
  &:hover {
    background: ${({ theme, isVariantDanger, isDisabled }) => isVariantDanger && !isDisabled ? theme.colors.danger100 : "neutral"};
  }
`;
var DocumentActionsMenu = ({ actions: actions2, children, label, variant: variant2 = "tertiary" }) => {
  ...
  return (0, import_jsx_runtime4.jsxs)(Menu.Root, {
    ...
    children: [
      (0, import_jsx_runtime4.jsxs)(Menu.Trigger, {
        disabled: isDisabled,
        size: "S",
        endIcon: null,
        paddingTop: "4px",
      ...
      (0, import_jsx_runtime4.jsxs)(Menu.Content, {
        ...
        children: [
          actions2.map((action) => {
            return (0, import_jsx_runtime4.jsx)(MenuItem2, {
              disabled: action.disabled,
      ...
      actions2.map((action) => {
        ...
        return (0, import_jsx_runtime4.jsxs)(React3.Fragment, {
          children: [
            ...
            ((_b = action.dialog) == null ? void 0 : _b.type) === "modal" ? (0, import_jsx_runtime4.jsx)(DocumentActionModal, {
              ...action.dialog,
              onModalClose: handleClose,
              isOpen: dialogId === action.id
            }) : null
...
var convertActionVariantToColor = (variant2 = "secondary") => {
  switch (variant2) {
    case "danger":
      return "danger600";
    case "secondary":
...
var convertActionVariantToIconColor = (variant2 = "secondary") => {
  switch (variant2) {
    case "danger":
      return "danger600";
    case "secondary":
...
var DocumentActionConfirmDialog = ({ onClose, onCancel, onConfirm, title, content, isOpen, variant: variant2 = "secondary", loading }) => {
  const { formatMessage } = useIntl();
  ...
  return (0, import_jsx_runtime4.jsx)(Dialog.Root, {
    open: isOpen,
    onOpenChange: handleClose,
    children: (0, import_jsx_runtime4.jsxs)(Dialog.Content, {
      children: [
        (0, import_jsx_runtime4.jsx)(Dialog.Header, {
          children: title
        }),
        (0, import_jsx_runtime4.jsx)(Dialog.Body, {
          children: content
        }),
        (0, import_jsx_runtime4.jsxs)(Dialog.Footer, {
          children: [
            (0, import_jsx_runtime4.jsx)(Dialog.Cancel, {
...
var DocumentActionModal = ({ isOpen, title, onClose, footer: Footer2, content: Content3, onModalClose }) => {
  const handleClose = () => {
    if (onClose) {
      onClose();
    }
  ...
  return (0, import_jsx_runtime4.jsx)(Modal.Root, {
    open: isOpen,
    onOpenChange: handleClose,
    children: (0, import_jsx_runtime4.jsxs)(Modal.Content, {
      children: [
        ...
        typeof Content3 === "function" ? (0, import_jsx_runtime4.jsx)(Content3, {
          onClose: handleClose
        }) : (0, import_jsx_runtime4.jsx)(Modal.Body, {
          children: Content3
        }),
        typeof Footer2 === "function" ? (0, import_jsx_runtime4.jsx)(Footer2, {
          onClose: handleClose
        }) : Footer2
      ]
    })
...
var PublishAction$1 = ({ activeTab, documentId, model, collectionType, meta, document: document2, onPreview }) => {
  ...
  const [localCountOfDraftRelations, setLocalCountOfDraftRelations] = React3.useState(0);
  const [serverCountOfDraftRelations, setServerCountOfDraftRelations] = React3.useState(0);
...
var UpdateAction = ({ activeTab, documentId, model, collectionType, onPreview }) => {
  ...
  const handleUpdate = React3.useCallback(async () => {
    setSubmitting(true);
    try {
      if (!modified) {
        return;
...
var UnpublishAction$1 = ({ activeTab, documentId, model, collectionType, document: document2 }) => {
  ...
  const { toggleNotification } = useNotification();
  const [shouldKeepDraft, setShouldKeepDraft] = React3.useState(true);
  ...
  return {
    ...
    icon: (0, import_jsx_runtime4.jsx)(ForwardRef$45, {}),
    onClick: async () => {
      ...
      content: (0, import_jsx_runtime4.jsxs)(Flex, {
        ...
        children: [
          (0, import_jsx_runtime4.jsxs)(Flex, {
            ...
            gap: 2,
            children: [
              (0, import_jsx_runtime4.jsx)(ForwardRef$3, {
                width: "24px",
                height: "24px",
                fill: "danger600"
              }),
          ...
          (0, import_jsx_runtime4.jsxs)(Radio.Group, {
            ...
            onValueChange: handleChange,
            children: [
              (0, import_jsx_runtime4.jsx)(Radio.Item, {
...
var RelativeTime = React3.forwardRef(({ timestamp, customIntervals = [], ...restProps }, forwardedRef) => {
  ...
  return (0, import_jsx_runtime4.jsx)("time", {
    ref: forwardedRef,
...
var DocumentStatus = ({ status = "draft", size = "S", ...restProps }) => {
  ...
  const { formatMessage } = useIntl();
  return (0, import_jsx_runtime4.jsx)(Status, {
    ...restProps,
    size,
...
var Header2 = ({ isCreating, status, title: documentTitle = "Untitled" }) => {
  const { formatMessage } = useIntl();
  const isCloning = useMatch(CLONE_PATH) !== null;
  ...
  return (0, import_jsx_runtime4.jsxs)(Flex, {
    ...
    gap: 2,
    children: [
      (0, import_jsx_runtime4.jsx)(BackButton, {
      ...
      (0, import_jsx_runtime4.jsxs)(Flex, {
        ...
        children: [
          ...
          (0, import_jsx_runtime4.jsx)(HeaderToolbar, {})
        ]
      }),
      status ? (0, import_jsx_runtime4.jsx)(Box, {
        marginTop: 1,
        children: (0, import_jsx_runtime4.jsx)(DocumentStatus, {
...
var HeaderToolbar = () => {
  ...
  return (0, import_jsx_runtime4.jsxs)(Flex, {
    gap: 2,
    children: [
      (0, import_jsx_runtime4.jsx)(DescriptionComponentRenderer, {
        props: {
          activeTab: status,
          model,
          documentId: id,
        ...
        children: (actions2) => {
          if (actions2.length > 0) {
            return (0, import_jsx_runtime4.jsx)(HeaderActions, {
              actions: actions2
            });
          } else {
            return null;
      ...
      (0, import_jsx_runtime4.jsx)(DescriptionComponentRenderer, {
        ...
        children: (actions2) => {
          ...
          return (0, import_jsx_runtime4.jsx)(DocumentActionsMenu, {
            actions: headerActions,
            label: formatMessage({
              id: "content-manager.containers.edit.header.more-actions",
              defaultMessage: "More actions"
            }),
            children: (0, import_jsx_runtime4.jsx)(Information, {
              activeTab: status
            })
          });
        }
...
var Information = ({ activeTab }) => {
  ...
  const information = [
    {
      ...
      value: formatMessage({
        ...
        time: (0, import_jsx_runtime4.jsx)(RelativeTime, {
  ...
  return (0, import_jsx_runtime4.jsx)(Flex, {
    ...
    */
    ...
    marginRight: "-0.4rem",
    width: "calc(100% + 8px)",
    children: information.map((info) => (0, import_jsx_runtime4.jsxs)(Flex, {
      gap: 1,
      direction: "column",
      alignItems: "flex-start",
      children: [
    ...
    children: actions2.map((action) => {
      if (action.options) {
        return (0, import_jsx_runtime4.jsx)(SingleSelect, {
          ...
          ...action,
          children: action.options.map(({ label, ...option }) => (0, import_jsx_runtime4.jsx)(SingleSelectOption, {
            ...option,
            children: label
          }, option.value))
        }, action.id);
        ...
        if (action.type === "icon") {
          return (0, import_jsx_runtime4.jsxs)(React3.Fragment, {
            children: [
              ...
              action.dialog ? (0, import_jsx_runtime4.jsx)(HeaderActionDialog, {
                ...action.dialog,
                isOpen: dialogId === action.id,
                onClose: handleClose
              }) : null
...
var HeaderActionDialog = ({ onClose, onCancel, title, content: Content3, isOpen }) => {
  const handleClose = async () => {
    if (onCancel) {
      await onCancel();
    }
...
var ConfigureTheViewAction = ({ collectionType, model }) => {
  ...
  return {
    ...
    icon: (0, import_jsx_runtime4.jsx)(ForwardRef$2n, {}),
    onClick: () => {
...
var EditTheModelAction = ({ model }) => {
  ...
  return {
    ...
    icon: (0, import_jsx_runtime4.jsx)(ForwardRef$1v, {}),
    onClick: () => {
...
var Panels = () => {
  ...
  return (0, import_jsx_runtime4.jsx)(Flex, {
    ...
    alignItems: "stretch",
    gap: 2,
    children: (0, import_jsx_runtime4.jsx)(DescriptionComponentRenderer, {
      props,
      descriptions: plugins["content-manager"].apis.getEditViewSidePanels(),
      children: (panels) => panels.map(({ content, id: id2, ...description }) => (0, import_jsx_runtime4.jsx)(Panel, {
        ...description,
        children: content
      }, id2))
    })
...
var ActionsPanel = () => {
  ...
  return {
    ...
    content: (0, import_jsx_runtime4.jsx)(ActionsPanelContent, {})
  };
};
  ...
  return (0, import_jsx_runtime4.jsxs)(Flex, {
    ...
    children: [
      (0, import_jsx_runtime4.jsx)(DescriptionComponentRenderer, {
        ...
        children: (actions2) => (0, import_jsx_runtime4.jsx)(DocumentActions, {
          actions: actions2
        })
      }),
      (0, import_jsx_runtime4.jsx)(InjectionZone, {
...
var Panel = React3.forwardRef(({ children, title }, ref) => {
  return (0, import_jsx_runtime4.jsxs)(Flex, {
    ref,
    tag: "aside",
...
var BoldChunk = (chunks) => (0, import_jsx_runtime4.jsx)(Typography, {
  fontWeight: "bold",
  children: chunks
});
var ConfirmDialogPublishAll = ({ isOpen, onToggleDialog, isConfirmButtonLoading = false, onConfirm }) => {
  ...
  return (0, import_jsx_runtime4.jsx)(ConfirmBulkActionDialog, {
    isOpen: isOpen && !isLoading,
    onToggleDialog,
    dialogBody: (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, {
      children: [
        (0, import_jsx_runtime4.jsxs)(Typography, {
        ...
        (schema == null ? void 0 : schema.pluginOptions) && "i18n" in schema.pluginOptions && (schema == null ? void 0 : schema.pluginOptions.i18n) && (0, import_jsx_runtime4.jsx)(Typography, {
          textColor: "danger500",
          textAlign: "center",
          children: formatMessage({
    ...
    endAction: (0, import_jsx_runtime4.jsx)(Button, {
      onClick: onConfirm,
      variant: "secondary",
...
var EntryValidationText = ({ validationErrors, status }) => {
  ...
  if (validationErrors) {
    ...
    return (0, import_jsx_runtime4.jsxs)(Flex, {
      gap: 2,
      children: [
        (0, import_jsx_runtime4.jsx)(ForwardRef$43, {
          fill: "danger600"
        }),
        (0, import_jsx_runtime4.jsx)(TooltipImpl, {
          description: validationErrorsMessages,
          children: (0, import_jsx_runtime4.jsx)(TypographyMaxWidth, {
            textColor: "danger600",
            variant: "omega",
            fontWeight: "semiBold",
            ellipsis: true,
  ...
  if (status === "modified") {
    return (0, import_jsx_runtime4.jsxs)(Flex, {
      gap: 2,
      children: [
        (0, import_jsx_runtime4.jsx)(ForwardRef$59, {
          fill: "alternative600"
        }),
        (0, import_jsx_runtime4.jsx)(Typography, {
          children: formatMessage({
...
var SelectedEntriesTableContent = ({ isPublishing, rowsToDisplay = [], entriesToPublish = [], validationErrors = {} }) => {
  ...
  return (0, import_jsx_runtime4.jsxs)(Table.Content, {
    children: [
      (0, import_jsx_runtime4.jsxs)(Table.Head, {
        children: [
          (0, import_jsx_runtime4.jsx)(Table.HeaderCheckboxCell, {}),
          TABLE_HEADERS.filter((head) => head.name !== "name" || shouldDisplayMainField).map((head) => (0, import_jsx_runtime4.jsx)(Table.HeaderCell, {
            ...head
          }, head.name))
        ]
      }),
      (0, import_jsx_runtime4.jsx)(Table.Loading, {}),
      (0, import_jsx_runtime4.jsx)(Table.Body, {
        children: rowsToDisplay.map((row) => (0, import_jsx_runtime4.jsxs)(Table.Row, {
          children: [
            (0, import_jsx_runtime4.jsx)(Table.CheckboxCell, {
              id: row.id
            }),
            (0, import_jsx_runtime4.jsx)(Table.Cell, {
              children: (0, import_jsx_runtime4.jsx)(Typography, {
                children: row.id
              })
            }),
            shouldDisplayMainField && (0, import_jsx_runtime4.jsx)(Table.Cell, {
              children: (0, import_jsx_runtime4.jsx)(Typography, {
            ...
            (0, import_jsx_runtime4.jsx)(Table.Cell, {
              children: isPublishing && entriesToPublish.includes(row.documentId) ? (0, import_jsx_runtime4.jsxs)(Flex, {
                gap: 2,
                children: [
                  (0, import_jsx_runtime4.jsx)(Typography, {
                    children: formatMessage({
                  ...
                  (0, import_jsx_runtime4.jsx)(Loader, {
                    small: true
                  })
                ]
              }) : (0, import_jsx_runtime4.jsx)(EntryValidationText, {
...
var PublicationStatusSummary = ({ count: count2, icon, message }) => {
  return (0, import_jsx_runtime4.jsxs)(Flex, {
    justifyContent: "space-between",
    flex: 1,
    gap: 3,
...
var PublicationStatusGrid = ({ entriesReadyToPublishCount, entriesPublishedCount, entriesModifiedCount, entriesWithErrorsCount }) => {
  ...
  return (0, import_jsx_runtime4.jsx)(Box, {
    hasRadius: true,
    borderColor: "neutral150",
    children: (0, import_jsx_runtime4.jsx)(TableComponent, {
      colCount: 2,
      rowCount: 2,
      children: (0, import_jsx_runtime4.jsxs)(Tbody, {
        children: [
          (0, import_jsx_runtime4.jsxs)(Tr, {
            children: [
              (0, import_jsx_runtime4.jsx)(Td, {
                children: (0, import_jsx_runtime4.jsx)(PublicationStatusSummary, {
                  count: entriesReadyToPublishCount,
                  icon: (0, import_jsx_runtime4.jsx)(ForwardRef$4D, {
                    fill: "success600"
                  }),
                  message: formatMessage({
                    id: "app.utils.ready-to-publish",
            ...
            children: [
              (0, import_jsx_runtime4.jsx)(Td, {
                children: (0, import_jsx_runtime4.jsx)(PublicationStatusSummary, {
                  ...
                  icon: (0, import_jsx_runtime4.jsx)(ForwardRef$59, {
                    fill: "alternative600"
                  }),
                  message: formatMessage({
                    id: "content-manager.bulk-publish.modified",
              ...
              (0, import_jsx_runtime4.jsx)(Td, {
                children: (0, import_jsx_runtime4.jsx)(PublicationStatusSummary, {
                  ...
                  icon: (0, import_jsx_runtime4.jsx)(ForwardRef$43, {
                    fill: "danger600"
                  }),
                  message: formatMessage({
...
var SelectedEntriesModalContent = ({ listViewSelectedEntries, toggleModal, setListViewSelectedDocuments, model }) => {
  ...
  const [isDialogOpen, setIsDialogOpen] = React3.useState(false);
  ...
  return (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, {
    children: [
      (0, import_jsx_runtime4.jsxs)(Modal.Body, {
        children: [
          (0, import_jsx_runtime4.jsx)(PublicationStatusGrid, {
          ...
          (0, import_jsx_runtime4.jsx)(Box, {
            marginTop: 7,
            children: (0, import_jsx_runtime4.jsx)(SelectedEntriesTableContent, {
      ...
      (0, import_jsx_runtime4.jsx)(ConfirmDialogPublishAll, {
        isOpen: isDialogOpen,
...
var PublishAction = ({ documents, model }) => {
  ...
  return {
    ...
    dialog: {
      ...
      content: ({ onClose }) => {
        return (0, import_jsx_runtime4.jsx)(Table.Root, {
          rows: documents,
          defaultSelectedRows: documents,
          headers: TABLE_HEADERS,
          children: (0, import_jsx_runtime4.jsx)(SelectedEntriesModalContent, {
...
var BulkActionsRenderer = () => {
  ...
  return (0, import_jsx_runtime4.jsx)(Flex, {
    ...
    children: (0, import_jsx_runtime4.jsx)(DescriptionComponentRenderer, {
      ...
      children: (actions2) => actions2.map((action) => (0, import_jsx_runtime4.jsx)(DocumentActionButton, {
        ...action
      }, action.id))
    })
  });
    ...
    dialog: {
      ...
      content: (0, import_jsx_runtime4.jsxs)(Flex, {
        ...
        children: [
          ...
          hasI18nEnabled && (0, import_jsx_runtime4.jsx)(Box, {
            textAlign: "center",
            padding: 3,
            children: (0, import_jsx_runtime4.jsx)(Typography, {
              textColor: "danger500",
...
var Emphasis = (chunks) => (0, import_jsx_runtime4.jsx)(Typography, {
  fontWeight: "semiBold",
  textColor: "danger500",
  children: chunks
});
        ...
        children: prohibitedFields.map(([fieldPath, reason]) => (0, import_jsx_runtime4.jsxs)(Flex, {
          ...
          children: [
            (0, import_jsx_runtime4.jsx)(Flex, {
              direction: "row",
              tag: "ol",
              children: fieldPath.map((pathSegment, index2) => (0, import_jsx_runtime4.jsxs)(Typography, {
                fontWeight: "semiBold",
                tag: "li",
                children: [
                  pathSegment,
                  index2 !== fieldPath.length - 1 && (0, import_jsx_runtime4.jsx)(ForwardRef$4v, {
                    fill: "neutral500",
                    height: "0.8rem",
                    width: "0.8rem",
                    style: {
...
var TableActions = ({ document: document2 }) => {
  ...
  return (0, import_jsx_runtime4.jsx)(DescriptionComponentRenderer, {
    props,
...
var EditAction = ({ documentId }) => {
  ...
  return {
    disabled: !canRead,
    icon: (0, import_jsx_runtime4.jsx)(StyledPencil, {}),
    label: formatMessage({
...
var CloneAction = ({ model, documentId }) => {
  ...
  const [prohibitedFields, setProhibitedFields] = React3.useState([]);
  return {
    disabled: !canCreate,
    icon: (0, import_jsx_runtime4.jsx)(StyledDuplicate, {}),
    label: formatMessage({
    ...
    dialog: {
      ...
      content: (0, import_jsx_runtime4.jsx)(AutoCloneFailureModalBody, {
        prohibitedFields
      }),
      footer: ({ onClose }) => {
        return (0, import_jsx_runtime4.jsxs)(Modal.Footer, {
          children: [
            (0, import_jsx_runtime4.jsx)(Button, {
              onClick: onClose,
              variant: "tertiary",
...
var HistoryAction = ({ model, document: document2 }) => {
  ...
  return {
    icon: (0, import_jsx_runtime4.jsx)(ForwardRef$4p, {}),
    label: formatMessage({
...
var PreviewSidePanel = ({ model, documentId, document: document2 }) => {
  ...
  return {
    ...
    content: (0, import_jsx_runtime4.jsx)(ConditionalTooltip, {
      label: formatMessage({
...
var index = {
  register(app) {
    ...
    app.router.addRoute({
      ...
      lazy: async () => {
        const { Layout } = await import("./layout-4nCaNnTs-MY3IW7GS.js");
        return {
          Component: Layout
        };
      },
...
prismjs/prism.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-JVMGJ7X3.js.map
