...
var NoReleases = () => {
  ...
  return (0, import_jsx_runtime2.jsx)(EmptyStateLayout, {
...
var AddActionToReleaseModal = ({ contentType, documentId, onInputChange, values }) => {
  ...
  if ((releases == null ? void 0 : releases.length) === 0) {
    return (0, import_jsx_runtime2.jsx)(NoReleases, {});
  }
  return (0, import_jsx_runtime2.jsxs)(Flex, {
    direction: "column",
    alignItems: "stretch",
        ...
        children: (0, import_jsx_runtime2.jsxs)(Field.Root, {
          ...
          children: [
            ...
            (0, import_jsx_runtime2.jsx)(SingleSelect, {
              ...
              children: releases == null ? void 0 : releases.map((release) => (0, import_jsx_runtime2.jsx)(SingleSelectOption, {
                value: release.id,
...
var ReleaseActionModalForm = ({ documentId, document, model, collectionType }) => {
  ...
  return {
    ...
    icon: (0, import_jsx_runtime2.jsx)(ForwardRef$1B, {}),
    ...
    dialog: {
      ...
      content: (0, import_jsx_runtime2.jsx)(AddActionToReleaseModal, {
        contentType: model,
        documentId,
        onInputChange: formik.setFieldValue,
        values: formik.values
      }),
      footer: ({ onClose }) => (0, import_jsx_runtime2.jsxs)(Modal.Footer, {
        children: [
...
var ReleaseAction = ({ documents, model }) => {
  ...
  return {
    ...
    dialog: {
      ...
      content: ({ onClose }) => {
        return (0, import_jsx_runtime2.jsx)(Formik, {
          onSubmit: async (values) => {
          ...
          validationSchema: RELEASE_ACTION_FORM_SCHEMA,
          initialValues: INITIAL_VALUES,
          children: ({ values, setFieldValue }) => (0, import_jsx_runtime2.jsxs)(Form, {
            children: [
              (releases == null ? void 0 : releases.length) === 0 ? (0, import_jsx_runtime2.jsx)(NoReleases, {}) : (0, import_jsx_runtime2.jsx)(Modal.Body, {
  ...
  return {
    displayedHeaders: [
      ...displayedHeaders,
      {
        ...
        cellFormatter: (props, _, { model }) => (0, import_jsx_runtime2.jsx)(ReleaseListCell, {
          ...props,
          model
        })
      }
...
var ReleaseListCell = ({ documentId, model }) => {
  ...
  const { formatMessage } = useIntl();
  return (0, import_jsx_runtime2.jsxs)(Popover.Root, {
    children: [
      (0, import_jsx_runtime2.jsx)(Popover.Trigger, {
        children: (0, import_jsx_runtime2.jsx)(Button, {
          variant: "ghost",
          onClick: (e) => e.stopPropagation(),
          // TODO: find a way in the DS to define the widht and height of the icon
          endIcon: releases.length > 0 ? (0, import_jsx_runtime2.jsx)(ForwardRef$4T, {
            width: "1.2rem",
            height: "1.2rem"
          }) : null,
      ...
      (0, import_jsx_runtime2.jsx)(Popover.Content, {
        children: (0, import_jsx_runtime2.jsx)("ul", {
          children: releases.map(({ id, name }) => (0, import_jsx_runtime2.jsx)(Box, {
            padding: 3,
            tag: "li",
            children: (0, import_jsx_runtime2.jsx)(Link2, {
...
var DeleteReleaseActionItem = ({ releaseId, actionId }) => {
  ...
  return (0, import_jsx_runtime2.jsx)(StyledMenuItem, {
    $variant: "danger",
    onSelect: handleDeleteAction,
    children: (0, import_jsx_runtime2.jsxs)(Flex, {
      gap: 2,
      children: [
        (0, import_jsx_runtime2.jsx)(ForwardRef$45, {
          width: "1.6rem",
          height: "1.6rem"
        }),
...
var EditReleaseItem = ({ releaseId }) => {
  ...
  return (
    /* @ts-expect-error inference isn't working in DS */
    (0, import_jsx_runtime2.jsx)(StyledMenuItem, {
      tag: NavLink,
      isLink: true,
...
var Panel = ({ model, document, documentId, collectionType }) => {
  ...
  return {
    ...
    content: (0, import_jsx_runtime2.jsx)(Flex, {
      direction: "column",
      alignItems: "stretch",
      gap: 3,
      width: "100%",
      children: releases == null ? void 0 : releases.map((release) => (0, import_jsx_runtime2.jsxs)(Flex, {
        direction: "column",
        alignItems: "start",
        borderWidth: "1px",
        borderStyle: "solid",
        ...
        children: [
          ...
          (0, import_jsx_runtime2.jsxs)(Flex, {
            ...
            children: [
              ...
              release.scheduledAt && release.timezone && (0, import_jsx_runtime2.jsx)(Typography, {
                variant: "pi",
              ...
              canDeleteAction ? (0, import_jsx_runtime2.jsxs)(ReleaseActionMenu.Root, {
                hasTriggerBorder: true,
                children: [
                  (0, import_jsx_runtime2.jsx)(ReleaseActionMenu.EditReleaseItem, {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-BEyv0kMo-NZFHJBV7.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-lky_0-wG-PMMTVG4O.js");
          return {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-U5sGMPgR-ZWXIVFOD.js");
          return {
...
//# sourceMappingURL=chunk-ZS36HJ6W.js.map
