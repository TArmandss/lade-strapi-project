...
var Initializer = ({ setPlugin }) => {
  const ref = (0, import_react2.useRef)(setPlugin);
...
var index = {
  register(app) {
    ...
    if (backendURL == null ? void 0 : backendURL.includes("localhost")) {
      app.addMenuLink({
        ...
        Component: async () => {
          const { App } = await import("./App-Dzr5m4eZ-PSYC2GAT.js");
          return App;
        }
      });
      const plugin = {
  ...
  async registerTrads(app) {
    ...
    const importedTrads = await Promise.all(
      locales.map((locale) => {
        return __variableDynamicImportRuntimeHelper(Object.assign({ "./translations/en.json": () => import("./en-DqzxMgb_-CMM7DD5T.js"), "./translations/fr.json": () => import("./fr-3fwSSssz-GPS3FEGC.js") }), `./translations/${locale}.json`, 3).then(({ default: data }) => {
          return {
...
//# sourceMappingURL=chunk-BRFBZRAI.js.map
